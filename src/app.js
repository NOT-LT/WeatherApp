...
const API_KEY = "get one from here https://openweathermap.org/";
...
locationInput.addEventListener('input', (event) => {
  ...
  if (foundlist?.length > 0) {
    foundlist.forEach((found) => {
      ...
      li.classList = "pl-8 pr-2 py-1 border-b-2 border-gray-100 relative cursor-pointer hover:bg-yellow-50 hover:text-gray-900";
      li.innerHTML = ` 
